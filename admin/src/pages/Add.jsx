...
const Add = ({ token }) => {
  ...
  const handleNavigation = () => {
    if (selectedOption === "stockList") {
      navigate("/add-stock-list");
    } else if (selectedOption === "wysiwyg") {
      navigate("/add-wysiwyg");
    }
  };

  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 p-6">
      <h2 className="text-2xl font-bold text-gray-800 mb-6">Choose Add Type</h2>
      ...
      >
        ...
        <option value="stockList">Add Stock List</option>
        <option value="wysiwyg">Add Wysiwyg</option>
      </select>
